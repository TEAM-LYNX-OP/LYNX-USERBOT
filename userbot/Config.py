...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "LynxBot")
       ...
       # PLUGIN_CHANNEL = int(os.environ.get("PLUGIN_CHANNEL", None))
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/TEAM-LYNX-OP/LYNX-USERBOT"
        )
        ...
        LYNXBOT_LOGGER = int(os.environ.get("LYNXBOT_LOGGER", None))
